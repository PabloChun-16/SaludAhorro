...
class AjusteIngresoForm(forms.ModelForm):
    """
    Formulario para registrar el encabezado de un Ingreso por Ajuste.
    ...
    class Meta:
        ...
        widgets = {
            "estado": forms.TextInput(attrs={
                "class": "form-control",
                "placeholder": "Ejemplo: Completado, En proceso, etc."
            }),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Por defecto, el estado podría inicializarse como “Completado”
