...
SECRET_KEY = 'django-insecure-$@n)8sq&jdjy=)hp!z8o5u6va#!ui&$dx4mbmbirzp8po9=zj9'
...
INSTALLED_APPS = [
    ...
    'apps.salidas_devoluciones.salidas',
    'apps.salidas_devoluciones.devoluciones',

    #Apps Ajustes de Inventario
